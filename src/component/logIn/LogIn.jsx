            ...
            <div className="cardContainerL">
                <div className="leftContainerL">
                    ...
                    <form onSubmit={handleSubmit} className="logInFormL">
                        ...
                        <input className="inputTagL" placeholder="Email" name="email" type="text" onChange={handleChange} value={data.email}/>
                        <input className="inputTagL" placeholder="Password" name="password" type="password" onChange={handleChange} value={data.password}/>
                        <button className="signInButtonL" type="submit">Sign In</button>
                    </form>
                </div>
